...
class Iiwa14KDLDynamic:
    ...
    def compute_dynamics(self, msg):
        ...
        print('myselfB(q): ')
        print(self.myself.get_B(list(current_joint_position)))

        print('C(q, qdot) * qdot: ')
        print(self.get_C_times_qdot(current_joint_position, joint_velocities))
        print('myselfC(q, qdot) * qdot: ')
        print(self.myself.get_C_times_qdot(list(current_joint_position), joint_velocities))

        print('g(q): ')
        print(self.get_G(current_joint_position))
        print('myselfg(q): ')
        print(self.myself.get_G(list(current_joint_position)))
