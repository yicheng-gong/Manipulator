...
if("FALSE" STREQUAL "TRUE")
  set(kdl_parser_py_SOURCE_PREFIX /home/yicheng/catkin_ws/src/comp0127_lab/kdl_parser_py)
  set(kdl_parser_py_DEVEL_PREFIX /home/yicheng/catkin_ws/devel)
  ...
  set(kdl_parser_py_INSTALL_PREFIX /home/yicheng/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
